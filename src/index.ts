let Case1 = document.getElementById('case1') as HTMLTableCellElement;
let Case2 = document.getElementById('case2') as HTMLTableCellElement;
let Case3 = document.getElementById('case3') as HTMLTableCellElement;
let Case4 = document.getElementById('case4') as HTMLTableCellElement;
let Case5 = document.getElementById('case5') as HTMLTableCellElement;
let Case6 = document.getElementById('case6') as HTMLTableCellElement;
let Case7 = document.getElementById('case7') as HTMLTableCellElement;
let Case8 = document.getElementById('case8') as HTMLTableCellElement;
let Case9 = document.getElementById('case9') as HTMLTableCellElement;
let BtnReplay = document.getElementById('Replay') as HTMLButtonElement;
let Joueur = document.getElementById('Joueur') as HTMLDivElement;

const tab: HTMLTableCellElement[] = [];
tab.push(Case1, Case2, Case3, Case4, Case5, Case6, Case7, Case8, Case9);
let SwitchPlayer: boolean = true;
const square: HTMLTableCellElement[][] = [
  [tab[0], tab[1], tab[2]],
  [tab[3], tab[4], tab[5]],
  [tab[6], tab[7], tab[8]],
  [tab[0], tab[3], tab[6]],
  ...
  tab.map((element) => {
      element.addEventListener('click', () => {
        ...
        */
        const ImpossibleToClickAfterAWin = tab.some(element =>
          ...
          const FullCase = tab.every(element => element.firstChild !== null);
             if(FullCase && AnyWinner){
              ...
              BTNValidate.onclick = function(){
                document.body.removeChild(document.getElementById('Shadow') as HTMLDivElement);
                document.body.removeChild(document.getElementById('DisplayContainer') as HTMLDivElement); 
              }
...
BtnReplay.addEventListener('click', () => {
 ...
 function PlayerWinOrNot(tableau: HTMLTableCellElement[], vainqueur: boolean) {
 ...
 function getValue(element: HTMLTableCellElement): null | string | undefined {
  const X:  null | NodeListOf<ChildNode> = element?.childNodes;
  
  console.log("X", X);
  if(X === null){
    return X;
  }else{
    const imageElement = X[0] as HTMLImageElement;
    let result = imageElement?.alt;
    return result;
  }
}
